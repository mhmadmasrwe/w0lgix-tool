 ...
 * Usage:
 *
 *     php mysql.php sql_server host username_list password_list
 */

if(count($argv) < 5) {
    echo "Usage:\n";
    echo " php mysql.php sql_server host username_list password_list";
}
...
if($host == null or $listuser == null or $listpass == null) {
	...
	die("Example: <service> <localhost> <users.txt> <pass.txt>\n");
}
