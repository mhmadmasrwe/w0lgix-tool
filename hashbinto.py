...
logo= """
 ...
 \033[1;31m/$$   /$$                     /$$              /$$$$$$                               /$$ \033[1;m     
\033[1;32m| $$  | $$                    | $$             /$$__  $$                             | $$      \033[1;m 
\033[1;33m| $$  | $$  /$$$$$$   /$$$$$$$| $$$$$$$       | $$  \__/  /$$$$$$  /$$$$$$   /$$$$$$$| $$   /$$\033[1;m 
\033[1;34m| $$$$$$$$ |____  $$ /$$_____/| $$__  $$      | $$       /$$__  $$|____  $$ /$$_____/| $$  /$$/\033[1;m 
\033[1;35m| $$__  $$  /$$$$$$$|  $$$$$$ | $$  \ $$      | $$      | $$  \__/ /$$$$$$$| $$      | $$$$$$/ \033[1;m 
\033[1;37m| $$  | $$ /$$__  $$ \____  $$| $$  | $$      | $$    $$| $$      /$$__  $$| $$      | $$_  $$ \033[1;m 
\033[1;30m| $$  | $$|  $$$$$$$ /$$$$$$$/| $$  | $$      |  $$$$$$/| $$     |  $$$$$$$|  $$$$$$$| $$ \  $$\033[1;m 
\033[1;31m|__/  |__/ \_______/|_______/ |__/  |__/       \______/ |__/      \_______/ \_______/|__/  \__/\033[1;m 
                                                                                               
                                                                                               
                                                                                                                             
                                    \033[1;47mCoded By w0lgix v1.2\033[1;m 
"""
class bcolors:
    HEADER = '\033[95m'
    OKBLUE = '\033[94m'
    ...
    ENDC = '\033[0m'
print logo
print "\033[1;32mselect 1-9\n\033[1;m"

print "\033[1;31m[1] md5  Decrypt\033[1;m"
print "\033[1;33m[2] md5 Decrypt Online\033[1;m"
print "\033[1;34m[3] sha1  Decrypt\033[1;m"
print "\033[1;35m[4] sha256 Decrypt\033[1;m"
print "\033[1;32m[5] sha384  Decrypt\033[1;m"
print "\033[1;36m[6] sha512 Decrypt\033[1;m"
print "\033[1;31m[7] wordpress Decrypt\033[1;m"
print "\033[1;33m[8] Joomla Decrypt\033[1;m"
print "\033[1;37m[9] Type Hash\033[1;m"
...
if  type1 == '1':
    ...
    for i in read:
        i = i.strip('\n')
        hash_object = hashlib.sha1(i.encode())
        hash2 = hash_object.hexdigest()
        if hash1 == hash2:
            os.system('clear')
            print logo
    ...
    for i in read:
         i = i.strip('\n')
         hash_object = hashlib.sha384(i.encode())
         hash2 = hash_object.hexdigest()
         if hash1 == hash2:
            os.system('clear')
            print logo
...
#$P$B8Qf5pBeISJFRTaVAMBjIcj4T8F46T.
#$P$BYDDY5m0963UI2I/0IEj0Dbp5CaMeP0
...
#--------------------------------------------------------
    ...
    print "\n\n[+]Cracking..."
    f=urllib.urlopen("http://md5.gromweb.com/?md5="+mhash)
    tas= f.read()
    link=re.compile('<em class="long-content string">'+'\w+')

    if link.search(tas):
        a= link.search(tas).group()
        print("\033[1;32m\n \n[+]Hash Cracked from md5broweb.com \n\033[1;m")
        strip = a.strip('<em class="long-content string">')
        print "\033[1;34mvalue="+mhash+':'+strip+'\033[1;m'
    else:
    ...
    data="hash="+mhash+"&decrypt=Decrypt"
    ...
    if link.search(tas):
        ...
        strip1 =  a.strip(': <br>')
        print "value="+mhash+':'+strip+'\033[1;m\n\n'

    else:
        print ("[+] Hash not found on md5decrypt.net\n")
    

    f=urllib2.urlopen("http://md5cracker.org/api/api.cracker.php?r=1421&database=md5online.net&hash="+mhash)
    tas= f.read()

    link=re.compile('lt":"\w+')

    if link.search(tas):
                a= link.search(tas).group()
                print("\033[1;35m[+]Hash Cracked from md5cracker.net \n\033[1;m")
                strip1 = a.strip('lt":"')
                print "\033[1;31mvalue="+mhash+':'+strip1+'\n\n'

    else:
                print "[+] Hash not found on md5decrypt.net\n"

    f1=urllib2.urlopen("http://md5cracker.org/api/api.cracker.php?r=4954&database=md5.my-addr.com&hash="+mhash)
    tas1= f1.read()

    link1=re.compile('lt":"\w+')

    if link1.search(tas1):
                a=link1.search(tas1).group()
                print("\033[1;36m[+]Hash Cracked from md5.my-addr.com \n\033[1;m")
                strip1 = a.strip('lt":"')
                print "\033[1;30mvalue="+mhash+':'+strip1+'\n\n\033[1;m'

    else:
                print "[+] Hash not found on md5.my-addr.com\n"


    f1=urllib2.urlopen("http://md5cracker.org/api/api.cracker.php?r=880&database=md5decryption.com&hash="+mhash)
    tas1= f1.read()
    ...
    if link1.search(tas1):
                a=link1.search(tas1).group()
                print("\033[1;37m[+]Hash Cracked from md5decryption.com \n\033[1;m")
                strip1 = a.strip('lt":"')
                print "\033[1;32mvalue="+mhash+':'+strip1+'\n\n\033[1;m'

    else:
                print "[+] Hash not found on md5decryption.com\n"
    
    f1=urllib2.urlopen("http://md5cracker.org/api/api.cracker.php?r=9940&database=md5.net&hash="+mhash)
    tas1= f1.read()
    ...
    if link1.search(tas1):
                a=link1.search(tas1).group()
                print("\033[1;34m[+]Hash Cracked from md5.net \n\033[1;m")
                strip1 = a.strip('lt":"')
                print "\033[1;35mvalue="+mhash+':'+strip1+'\n\n\033[1;m'

    else:
                print "[+] Hash not found on md5.net\n"

    f1=urllib2.urlopen("http://md5cracker.org/api/api.cracker.php?r=2687&database=md5crack&hash="+mhash)
    tas1= f1.read()
    ...
    if link1.search(tas1):
                a=link1.search(tas1).group()
                print("\033[1;37m[+]Hash Cracked from md5crack \n\033[1;m")
                strip1 = a.strip('lt":"')
                print "\033[1;31mvalue="+mhash+':'+strip1+'\n\n\033[1;m'

    else:
                print "[+] Hash not found on md5crack\n"

    f1=urllib2.urlopen("http://md5cracker.org/api/api.cracker.php?r=4972&database=netmd5crack&hash="+mhash)
    tas1= f1.read()
    ...
    if link1.search(tas1):
                a=link1.search(tas1).group()
                print("\033[1;34m[+]Hash Cracked from netmd5crack \n\033[1;m")
                strip1 = a.strip('lt":"')
                print "\033[1;36mvalue="+mhash+':'+strip1+'\n\n\033[1;m'

    else:
                print "[+] Hash not found on netmd5crack\n"

    f1=urllib2.urlopen("http://md5cracker.org/api/api.cracker.php?r=6573&database=authsecu&hash="+mhash)
    tas1= f1.read()
    ...
    if link1.search(tas1):
                a=link1.search(tas1).group()
                print("\033[1;37m[+]Hash Cracked from authsecu \n\033[1;m")
                strip1 = a.strip('lt":"')
                print "\033[1;30mvalue="+mhash+':'+strip1+'\n\n\033[1;m'

    else:
                print "[+] Hash not found on authsecu\n"

    f1=urllib2.urlopen("http://md5cracker.org/api/api.cracker.php?r=5916&database=md5pass&hash="+mhash)
    tas1= f1.read()
    ...
    if link1.search(tas1):
                a=link1.search(tas1).group()
                print("\033[1;33m[+]Hash Cracked from md5pass \n\033[1;m")
                strip1 = a.strip('lt":"')
                print "\033[1;34mvalue="+mhash+':'+strip1+'\n\n\033[1;m'

    else:
                print "[+] Hash not found on md5pass\n"

    f1=urllib2.urlopen("http://md5cracker.org/api/api.cracker.php?r=9236&database=i337.net&hash="+mhash)
    tas1= f1.read()
    ...
    if link1.search(tas1):
                a=link1.search(tas1).group()
                print("\033[1;37m[+]Hash Cracked from i337.net \n\033[1;m")
                strip1 = a.strip('lt":"')
                print "\033[1;32mvalue="+mhash+':'+strip1+'\n\n\033[1;m'

    else:
                print "[+] Hash not found on i337.net\n"
    ...
    for i in read:
         i = i.strip('\n')
         hash_object = hashlib.sha512(i.encode())
         hash2 = hash_object.hexdigest()
         if hash1 == hash2:
            os.system('clear')
            print logo
	...
	original = raw_input("Hash: ").split(':')
	wordlist = raw_input("wordlist path: ")
	_md5 = original[0]
	_salt = original[1]
	plist = open(wordlist).readlines()

	for line in plist:
    	 line = line.strip()
    	 attempt = hashlib.md5(line + _salt).hexdigest()
    	 if(attempt == _md5):
        	print bcolors.OKGREEN + "\n" + _md5 + _salt +':' + line
        	sys.exit(0)
	else:
			print bcolors.OKBLUE+'Password not found : - ):'
			sys.exit(1)
